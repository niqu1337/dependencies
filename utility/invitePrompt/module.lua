...
Inviter.Join = function(invite)
	local success, inviteData = pcall(function()
		return HS:JSONDecode(SelfModules.Functions.Request({ Url = "https://canary.discord.com/api/invites/".. getInviteCode(invite), Method = "GET" }).Body)
	end)
...
Inviter.Prompt = function(options)
	local success, inviteData = pcall(function()
		return HS:JSONDecode(SelfModules.Functions.Request({ Url = "https://canary.discord.com/api/invites/".. getInviteCode(options.invite), Method = "GET" }).Body)
	end)
